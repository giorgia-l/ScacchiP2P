...
//        drawBoard(gp);
    ...
    public void drawBoard(Graphics gp) {
        ...
        for (int y = 0; y < 8; y++) {
            for (int x = 0; x < 8; x++) {
                ...
                gp.fillRect(x * dimensioneCella, y * dimensioneCella, dimensioneCella, dimensioneCella);
                white = !white;
            }
            white = !white;
        }
        ...
        for (int y = 0; y < 8; y++) {
            for (int x = 0; x < 8; x++) {
                gp.drawImage(board[x][y].getPiece().getPiece(), x * dimensioneCella, y  * dimensioneCella, this);
            }
        }
    }
